...
static emlrtRSInfo emlrtRSI = {
    ...
    "Simmechanics\\btp_alinjar\\lfval.m" /* pathName */
};
           ...
           real_T cmb3g[3], real_T Qd3g[9])
{
  ...
  /*  Qd0geul=quat2eul(Qquat); */
  /*  Qd0g=eul2rotm(Qd0geul); */
  x = muDoubleScalarSin(qhb);
  tempR_tmp = muDoubleScalarCos(qhb);
  Qd10[0] = tempR_tmp;
  Qd10[3] = 0.0;
  Qd10[6] = x;
  Qd10[1] = 0.0;
  ...
  Qd10[5] = 0.0;
  Qd10[8] = tempR_tmp;
  x = muDoubleScalarSin(qkb);
  tempR_tmp = muDoubleScalarCos(qkb);
  b_tempR_tmp = muDoubleScalarSin(qab);
  c_tempR_tmp = muDoubleScalarCos(qab);
  ...
  for (b_i = 0; b_i < 3; b_i++) {
    ...
    cmb3g[b_i] = e_tempR_tmp;
    ab2g[b_i] = d_tempR_tmp;
    ab1g[b_i] = c_tempR_tmp;
    eb3g[b_i] = b_tempR_tmp;
    eb2g[b_i] = tempR_tmp;
    eb1g[b_i] = x;
    cmb1g[b_i] = c_tempR_tmp / 2.0;
    cmb2g[b_i] = d_tempR_tmp / 2.0;
  }
}

/* End of code generation (lfval.c) */
