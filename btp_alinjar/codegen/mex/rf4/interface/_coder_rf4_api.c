 ...
 * _coder_rf4_api.c
 *
 * Code generation for function '_coder_rf4_api'
 *
 */
...
void rf4_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  rf4(ankle, knee, hip, *t2dRF);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*t2dRF);
}

/* End of code generation (_coder_rf4_api.c) */
