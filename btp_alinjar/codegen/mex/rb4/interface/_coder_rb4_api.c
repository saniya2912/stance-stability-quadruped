 ...
 * _coder_rb4_api.c
 *
 * Code generation for function '_coder_rb4_api'
 *
 */
...
void rb4_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  t2dRF = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  rb4(ankle, knee, hip, *t2dRF);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*t2dRF);
}

/* End of code generation (_coder_rb4_api.c) */
