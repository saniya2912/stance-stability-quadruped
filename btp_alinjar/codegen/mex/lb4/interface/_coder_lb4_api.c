 ...
 * _coder_lb4_api.c
 *
 * Code generation for function '_coder_lb4_api'
 *
 */
...
void lb4_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  t2dLB = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  lb4(ankle, knee, hip, *t2dLB);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*t2dLB);
}

/* End of code generation (_coder_lb4_api.c) */
