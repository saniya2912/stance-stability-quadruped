 ...
 * _coder_rf3_api.c
 *
 * Code generation for function '_coder_rf3_api'
 *
 */
...
void rf3_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  rf3(ankle, knee, hip, *tdRF);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*tdRF);
}

/* End of code generation (_coder_rf3_api.c) */
