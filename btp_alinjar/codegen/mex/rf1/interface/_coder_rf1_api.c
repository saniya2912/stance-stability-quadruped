 ...
 * _coder_rf1_api.c
 *
 * Code generation for function '_coder_rf1_api'
 *
 */
...
void rf1_api(const mxArray *prhs, int32_T nlhs, const mxArray *plhs[3])
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  rf1(*theta_2d_des, &t2ddhip, &t2ddknee, &t2ddankle);
...
/* End of code generation (_coder_rf1_api.c) */
