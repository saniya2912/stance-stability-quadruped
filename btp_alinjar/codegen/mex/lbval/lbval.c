...
static emlrtRSInfo emlrtRSI = {
    ...
    "Simmechanics\\btp_alinjar\\lbval.m" /* pathName */
};
           ...
           real_T cmd3g[3], real_T Qd3g[9])
{
  ...
  x = muDoubleScalarSin(qhd);
  tempR_tmp = muDoubleScalarCos(qhd);
  Qd10[0] = tempR_tmp;
  Qd10[3] = 0.0;
  Qd10[6] = x;
  Qd10[1] = 0.0;
  ...
  Qd10[5] = 0.0;
  Qd10[8] = tempR_tmp;
  x = muDoubleScalarSin(qkd);
  tempR_tmp = muDoubleScalarCos(qkd);
  b_tempR_tmp = muDoubleScalarSin(qad);
  c_tempR_tmp = muDoubleScalarCos(qad);
  ...
  for (b_i = 0; b_i < 3; b_i++) {
    ...
    cmd3g[b_i] = e_tempR_tmp;
    ad2g[b_i] = d_tempR_tmp;
    ad1g[b_i] = c_tempR_tmp;
    ed3g[b_i] = b_tempR_tmp;
    ed2g[b_i] = tempR_tmp;
    ed1g[b_i] = x;
    cmd1g[b_i] = c_tempR_tmp / 2.0;
    cmd2g[b_i] = d_tempR_tmp / 2.0;
  }
}

/* End of code generation (lbval.c) */
