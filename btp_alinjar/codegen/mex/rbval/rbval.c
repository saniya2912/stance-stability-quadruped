...
static emlrtRSInfo emlrtRSI = {
    ...
    "Simmechanics\\btp_alinjar\\rbval.m" /* pathName */
};
           ...
           real_T cmc3g[3], real_T Qd3g[9])
{
  ...
  x = muDoubleScalarSin(qhc);
  tempR_tmp = muDoubleScalarCos(qhc);
  Qd10[0] = tempR_tmp;
  Qd10[3] = 0.0;
  Qd10[6] = x;
  Qd10[1] = 0.0;
  ...
  Qd10[5] = 0.0;
  Qd10[8] = tempR_tmp;
  x = muDoubleScalarSin(qkc);
  tempR_tmp = muDoubleScalarCos(qkc);
  b_tempR_tmp = muDoubleScalarSin(qac);
  c_tempR_tmp = muDoubleScalarCos(qac);
  ...
  for (b_i = 0; b_i < 3; b_i++) {
    ...
    cmc3g[b_i] = e_tempR_tmp;
    ac2g[b_i] = d_tempR_tmp;
    ac1g[b_i] = c_tempR_tmp;
    ec3g[b_i] = b_tempR_tmp;
    ec2g[b_i] = tempR_tmp;
    ec1g[b_i] = x;
    cmc1g[b_i] = c_tempR_tmp / 2.0;
    cmc2g[b_i] = d_tempR_tmp / 2.0;
  }
}

/* End of code generation (rbval.c) */
