 ...
 * _coder_lf4_api.c
 *
 * Code generation for function '_coder_lf4_api'
 *
 */
...
void lf4_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  t2dLF = (real_T(*)[3])mxMalloc(sizeof(real_T[3]));
  ...
  lf4(ankle, knee, hip, *t2dLF);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*t2dLF);
}

/* End of code generation (_coder_lf4_api.c) */
