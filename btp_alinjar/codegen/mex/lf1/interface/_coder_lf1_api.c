 ...
 * _coder_lf1_api.c
 *
 * Code generation for function '_coder_lf1_api'
 *
 */
...
void lf1_api(const mxArray *prhs, int32_T nlhs, const mxArray *plhs[3])
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  lf1(*theta_2d_des, &t2ddhip, &t2ddknee, &t2ddankle);
...
/* End of code generation (_coder_lf1_api.c) */
