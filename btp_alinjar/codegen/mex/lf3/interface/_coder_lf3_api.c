 ...
 * _coder_lf3_api.c
 *
 * Code generation for function '_coder_lf3_api'
 *
 */
...
void lf3_api(const mxArray *const prhs[3], const mxArray **plhs)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  lf3(ankle, knee, hip, *tdRF);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*tdRF);
}

/* End of code generation (_coder_lf3_api.c) */
